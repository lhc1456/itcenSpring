...
<div>
	...
	<c:if test="${list == 'admin' }">
		<form action="deleteAdminList" method="post" name="delF">
			<fieldset id="page">
					...
					<table class="bottomBtn">
						<tbody>
							<tr>
								...
								<td><input type="button" value="추가" onclick="javascript:window.location='addAdmin_view'" /></td>
	...
	<c:if test="${ list == 'member' }">
		<form action="deleteMemberList" method="post" name="delF">
			<fieldset id="page">
